{
	...
	e os armazene em uma matriz 5x5 
	(preencha primeiros as linhas depois as colunas) “MAT[linha,coluna]”, 
	em seguida o programa deve exibir na tela a posição do maior número.
}

program manipulacaoArquivo;
